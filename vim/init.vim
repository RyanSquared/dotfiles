...
autocmd FileType htmldjango set sw=2 ts=2 et
autocmd FileType cpp set sw=2 ts=2 et
autocmd FileType json set sw=2 ts=2 et
autocmd FileType rust set sw=4 ts=4 et
autocmd FileType sh set sw=2 ts=2 et
autocmd FileType tf set sw=2 ts=2 et
